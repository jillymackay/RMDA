...
![Research Methods and Data Analysis (IAWEL) Cover](assets/cover.png){fig-alt="A black and white line drawing of a duck" fig-align="center" width="300"}

# Preface {.unnumbered}

This book accompanies the Research Methods and Data Analysis course on the [International Animal Welfare Ethics and Law MSc](https://vet.ed.ac.uk/education/postgraduate/taught/animal-welfare) at the [Royal (Dick) School of Veterinary Studies](https://vet.ed.ac.uk/).

It is a companion document to the course, and not core to the materials, however we choose to make this publically available as part of our commitment to open science frameworks and accessibility in education.
